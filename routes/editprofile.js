...
router.post('/editprofile', authenticate, async (req, res) => {
    ...
    if(user.counter === 0) {
        ...
        userToBeUpdated.mobilenum = userToBeUpdated.mobilenum ? body.mobile : body.mobile;
        userToBeUpdated.state = userToBeUpdated.state ? body.state : body.state;
        userToBeUpdated.address = userToBeUpdated.address ? body.address : body.address;
        userToBeUpdated.sec_que = userToBeUpdated.sec_que ? body.sec_que : body.sec_que;
        userToBeUpdated.sec_ans = userToBeUpdated.sec_ans ? body.sec_ans.toLowerCase() : body.sec_ans.toLowerCase();
